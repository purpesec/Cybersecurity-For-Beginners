...
1. Prepara el entorno con la guía de configuración.
2. Elige una ruta y revisa sus prerrequisitos.
3. Estudia la teoría y ejecuta el laboratorio guiado.
4. Conserva comandos, salidas, capturas y notas de análisis.
5. Valida los criterios de finalización.
